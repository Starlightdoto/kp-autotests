...
test('The Third page main checks', async () => {
    ...
    await threePage.emailInput.fill('auto_test_treepage_sbp_fail_3page_send@test.com');
});
...
test('Cancellation with receipt attaching', async () => {
    ...
    await threePage.commentInput.fill ('auto_test_tree_page_sbp_fail_3page_send comment');
