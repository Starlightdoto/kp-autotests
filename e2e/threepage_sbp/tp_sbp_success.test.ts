...
test('Attaching Bank Receipt Modal Window checks', async () => {
    ...
    await threePage.transferRulesButton.click();
    await threePage.attachingBankReceiptButton.click();
    await threePage.commentInputInAttachingBankReceiptModal.fill('auto_test_tree_page_sbp');
    await threePage.emailInputInAttachingBankReceiptModal.fill('auto_test_tree_page_sbp@test.com');
...
test('Help modal window checks', async () => {
    ...
    await globalPage.waitForTimeout(2000);
    // const transferDetailsInstruction = await globalPage.locator('//*[@id="pv_id_14_0_header_action"]');
    ...
    // await expect (transferDetailsInstruction).toBeVisible();
    ...
    // await transferDetailsInstruction. click();
...
test('The Third page main checks', async () => {
    ...
    await threePage.emailInput.fill('auto_test_treepagesbp@test.com');
});
