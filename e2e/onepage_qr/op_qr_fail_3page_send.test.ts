...
test('Transfer completed page main checks', async () => {
    ...
    await onePage.emailInput.fill('auto_test_one_page_qr_fail_3page_send@test.com');
});
...
test('Cancellation with receipt attaching', async () => {
    ...
    await onePage.commentInputInCancellationReasonModal.fill ('auto_test_one_page_qr_fail_3page_send comment');
