...
test('Attaching Bank Receipt Modal Window checks', async () => {
    ...
    await onePage.transferRulesButton.click();
    await onePage.attachingBankReceiptButton.click();
    await onePage.commentInputInAttachingBankReceiptModal.fill('auto_test_one_page_sbp');
    await onePage.emailInputInAttachingBankReceiptModal.fill('auto_test_one_page_sbp@test.com');
...
test('Transfer completed page main checks', async () => {
    ...
    await onePage.emailInput.fill('auto_test_one_page_sbp@test.com');
});
